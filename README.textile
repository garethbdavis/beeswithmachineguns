...
PLEASE NOTE: This is an experimental fork that attempts to support authentication and xsrf tokens/headers on a per-bee level.
Changes made here may be brittle, it is recommended that you use https://github.com/newsapps/beeswithmachineguns.
...
Options:
  ...
  up:
    ...
    -D DELAY, --delay=DELAY
                        Additional delay in seconds between bringing up bees
                        and attacking. (default: 0).
  ...
  attack:
    ...
    -K, --keepalive     Keep-Alive connection.
